...
public class WechatFilter implements Filter {
	...
	private String extractRequestInfo(HttpServletRequest request) {
		...
		String requestFullPath = StringUtils.isEmpty(request.getQueryString()) ? StringUtils.EMPTY : ("?" + request.getQueryString());
		stringBuffer.append("url=").append(request.getRequestURI() + requestFullPath)
