...
public interface ProductItemRepo extends CrudRepository<ProductItem, Long> {
	...
	public Page<ProductItem> findByProductInAndIsActiveOrderByStartDateDesc(List<Product> products, String isActive,
			Pageable pageable);

	public Page<ProductItem> findByProductStatusInAndStartDateBeforeAndIsActiveOrderByProductStatusAscFixTopDescExpiredDateAsc(
