...
and o.product_item_id=pi.product_item_id and pi.product_status=3
and o.is_active='Y' and o.payment_id is not null and o.order_status in (2,3,4) and o.product_item_id is not null
and o.unit_price>pi.current_price and o.order_date>'2016-08-01'
and o.order_id not in 
(select order_id from user_refund where is_active='Y' and refund_type in (0))) res
left join 
